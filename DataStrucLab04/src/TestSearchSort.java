    ...
    while (keepGoing) {
      ...
      switch (option) {
        ...
        case 2 -> {
          ...
          if (!isFilled) {
            System.out.println("Please fill your array!");
            break;
          }
        ...
        case 4 -> {
          ...
          switch (input) {
            ...
            case 'D' -> {
              ...
              System.out.println(
                  "Bubble sort took: " + nanoBulba + " nanoseconds, or " + nanoBulba / 1000000 + " milliseconds");
              System.out.println("Insertion sort took: " + nanoInsertion + " nanoseconds, or " + nanoInsertion / 1000000
                  + " milliseconds");
              System.out.println("Selection sort took: " + nanoSelection + " nanoseconds, or " + nanoSelection / 1000000
                  + " milliseconds");
              System.out.println(
                  "Merge sort took: " + nanoMerge + " nanoseconds, or " + nanoMerge / 1000000 + " milliseconds");
              System.out.println(
                  "Quick sort took: " + nanoQuick + " nanoseconds, or " + nanoQuick / 1000000 + " milliseconds");
            }
